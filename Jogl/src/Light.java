...
class Light extends GLJPanel implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, this.colorLightYellow, 0);
